...
from n3rv.providers.models import ProviderError, ToolCall, ToolResult
...
class OpenAIProvider(ModelProvider):
    ...
    def _default_model(self) -> str:
        return os.environ.get("N3RV_DEFAULT_MODEL") or "gpt-4"

    def _default_base_url(self) -> str:
        return os.environ.get("N3RV_DEFAULT_BASE_URL") or "https://api.openai.com/v1"
