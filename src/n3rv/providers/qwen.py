...
# Set via N3RV_QWEN_BASE_URL env var or the base_url constructor arg.
#
...
_TIMEOUT_SEC = 60.0
_MAX_TOKENS = 4096
_BASE_URL_ENV_VAR = "N3RV_QWEN_BASE_URL"
...
class QwenProvider(ModelProvider):
    ...
    def _default_model(self) -> str:
        return os.environ.get("N3RV_DEFAULT_MODEL") or DEFAULTS.model

    def _default_base_url(self) -> str:
        return os.environ.get(_BASE_URL_ENV_VAR) or os.environ.get("N3RV_DEFAULT_BASE_URL") or DEFAULTS.base_url
